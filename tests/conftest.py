...
def mock_env(monkeypatch, tmp_path):
    ...
    It overrides GDRIVE_MOUNT and WORKSPACE_DIR to point to a temporary directory
    so that no real files are ever affected during unit testing.
    """
    # Create mock directories
    gdrive_mock = tmp_path / "gdrive_mock"
    gdrive_mock.mkdir()
