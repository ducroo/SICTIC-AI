...
1. **Filename Generation & Caching:** 
   ...
   * Construct the output file path: `<GDRIVE_MOUNT>/insights/<startup_name>/<startup_name>_traction_<model_name>.md`. 
...
4. **Output Generation:** 
   * Ensure the output directory `<GDRIVE_MOUNT>/insights/<startup_name>/` exists. 
